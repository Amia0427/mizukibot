...
module.exports = {
  ...
  MODEL_SELF_CHECK_TIMEOUT_MS: Math.max(1000, pickNum('MODEL_SELF_CHECK_TIMEOUT_MS', 8000)),
  ...
  MCP_WARM_ON_RUNTIME_INIT: pickBool('MCP_WARM_ON_RUNTIME_INIT', true),
  ...
  MEMORY_LANCEDB_CANDIDATE_LIMIT: pickNum('MEMORY_LANCEDB_CANDIDATE_LIMIT', 32),
  ...
  MEMORY_RERANK_CANDIDATE_LIMIT: pickNum('MEMORY_RERANK_CANDIDATE_LIMIT', 12),
  ...
  PERSONA_WORLDBOOK_PLANNER_CANDIDATE_LIMIT: pickNum('PERSONA_WORLDBOOK_PLANNER_CANDIDATE_LIMIT', 20),
