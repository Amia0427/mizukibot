...
module.exports = {
  ...
  RESOURCE_PRESSURE_ENABLED: pickBool('RESOURCE_PRESSURE_ENABLED', false),
  RESOURCE_PRESSURE_HEAP_USED_MB: pickNum('RESOURCE_PRESSURE_HEAP_USED_MB', 1024),
  RESOURCE_PRESSURE_RSS_MB: pickNum('RESOURCE_PRESSURE_RSS_MB', 1536),
  ...
  MEMORY_CLI_PRELOAD: pickBool('MEMORY_CLI_PRELOAD', true),
