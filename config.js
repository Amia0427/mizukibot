...
module.exports = {
  ...
  // 支持 `command` 与 `openclaw` 两种后端，默认保持通用命令模式。
  ...
  CONTINUOUS_MESSAGE_AT_BOT_DEBOUNCE_MS: pickNum('CONTINUOUS_MESSAGE_AT_BOT_DEBOUNCE_MS', 2000),
  ...
  MEMORY_RERANK_TIMEOUT_MS: pickNum('MEMORY_RERANK_TIMEOUT_MS', 12000),
