...
module.exports = {
  ...
  MCP_DISCOVERY_MODE: pick('MCP_DISCOVERY_MODE', lowResourceMode ? 'lazy' : 'warm').toLowerCase(),
  MCP_WARM_ON_RUNTIME_INIT: pickBool('MCP_WARM_ON_RUNTIME_INIT', !lowResourceMode),
