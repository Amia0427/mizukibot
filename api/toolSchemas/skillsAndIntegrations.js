...
const skillsAndIntegrationsToolSchemas = [
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Render bot-authored inline SVG or HTML into a PNG and send it to the current QQ chat. Use for diagrams, charts, posters, information cards and simple vector illustrations. Never pass URLs, files or user-authored markup.',
      parameters: {
        type: 'object',
        additionalProperties: false,
        properties: {
          renderer: { type: 'string', enum: ['svg', 'html'], description: 'Prefer svg unless HTML/CSS layout is necessary' },
          markup: { type: 'string', description: 'Complete SVG document or HTML fragment generated by the assistant' },
          width: { type: 'integer', minimum: 320, maximum: 1200, description: 'Output width in pixels, defaults to 800' },
          max_height: { type: 'integer', minimum: 200, maximum: 2000, description: 'Maximum output height in pixels, defaults to 1600' }
        },
        required: ['renderer', 'markup']
      }
    }
  },
  {
