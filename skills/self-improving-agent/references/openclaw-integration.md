...
- Linux default state dir: `~/.openclaw/`
- This local Windows host currently uses state dir: `C:/Users/Administrator/.openclaw/`
- This local Windows host currently uses workspace dir: `C:/Users/Administrator/openclaw/.openclaw/workspace`
- When the examples below use `cp`, `mkdir -p`, or `~/.openclaw/...`, map them to the Windows paths above.
