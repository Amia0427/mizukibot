...
const {
  ...
  normalizeJargonRole,
  normalizeStatus,
  isImplicitJournalCue,
  getItemMemoryKind,
  isSignalMemoryKind,
  getStaleCandidatePenalty,
  canonicalizeText,
  tokenize,
  cosineMap,
  buildTfidfVec,
...
const {
  deriveDocCategoryMetadata,
  calcCategoryBoost,
  calcMemoryStrength,
  calcRecencyScore,
  calcOverlapBoost,
  calcDirectBoost,
  calcParticipantBoost,
  calcGraphBoost,
  calcScopeBoost,
  calcTierBoost,
  calcConfidenceBoost,
  formatReason,
  applySignalRecallAdjustments,
  classifyDocSource
} = require('./scoring-core');
const { touchAccessStats } = require('./stats-runtime');
const { calcEmbeddingScore } = require('./embedding');
...
module.exports = {
  ...
  annotateSelectedHits,
  resolveSelectionFacet,
  isFacetPriorityEnabled,
  isFacetPreferredHit,
  isStrongSemanticHit,
  scoreDocsAsync
};
