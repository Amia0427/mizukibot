...
const { shouldBiasToContinuity } = require('../../../utils/recallHeuristics');
...
module.exports = {
  ...
  docMatchesCategoryFilters,
  calcCategoryBoost,
  getLayerHalfLifeDays,
  calcMemoryStrength,
  calcRecencyScore,
  calcOverlapBoost,
  calcLexicalScore,
  ...
  calcTierBoost,
  calcConfidenceBoost,
  calcDuplicationPenalty,
  formatReason,
  isStyleOrToneQuery,
  applySignalRecallAdjustments,
  filterDocIdsByOptions,
  collectDocsFromShardCategories,
  resolveUnifiedShardCategories,
  classifyDocSource,
  filterUnifiedDocIds
};
