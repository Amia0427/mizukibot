...
const { maybeSendMemeFollowup } = require('../../../core/memeManager');
const { shortTermMemory } = require('../../../utils/memory');
const { getShortTermPresence } = require('../../../utils/shortTermMemory');
const {
  appendGroupMessage,
  canReplyInHour,
...
const {
  ...
  applySocialContextGate,
  buildConversationWindow,
  buildPresenceReason,
  canCallDecisionModel,
  canCallReplyModel,
  classifyPassiveReplyType,
  collectPassiveVisualInputs,
  detectPassiveAddressee,
  getEffectivePassiveText,
  getSenderName,
  hasPassiveVisualInput,
  isEnabledForGroup,
  isNoiseText,
  markPassiveSafetyRestrictionEmoji,
  normalizeDirectedContext,
  normalizePassiveReplyText,
  normalizePresenceAction,
  normalizePresenceState,
  normalizeText,
  scoreMessageTrigger,
  shouldGatePassiveReply,
  shouldProbePassiveVisualCue,
  shouldSuppressPresenceAck,
  shouldSuppressTrivialPresenceReply,
  trimReplyText
} = require('./core');
const {
  advancePresenceBeforeDecision,
  applyPresenceDecision,
  buildPresenceSnapshot,
  decidePresenceAction,
  getPresenceConfig,
  getSessionKeyForPresence,
  hasStrongBotCue,
  shouldCheckReplyIntervals
} = require('./presence-runtime');
const {
  buildLocalReplyFallback,
  cheapRuleGate,
  invokeDecisionModel,
  invokeReplyModel,
  shouldForceStrongCueReply,
  shouldUseLocalDecisionFallback
} = require('./model-runtime');
const { forcePassiveGroupInterjection } = require('./force');
