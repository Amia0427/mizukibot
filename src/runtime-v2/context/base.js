...
const promptBlocks = require('./prompt-blocks-runtime');
const { blocksToMessages, createLiveStatePromptBlock, createPromptBlock, serializePromptBlocks } = promptBlocks;
const { buildCacheFriendlyFingerprint, splitBlocksByLane } = require('./cache-runtime');
...
const {
  ...
  summarizeShortTermContinuityForPrompt
} = require('./continuity');
const {
  ...
  removeDuplicateJournalPromptText,
...
const { getRouteMetaGroupId, isGroupDirectChatRoute } = require('./route-timing');
...
module.exports = { buildBaseDynamicPrompt };
