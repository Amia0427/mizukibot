...
const TOOL_ROUTING_METADATA = Object.freeze({
  get_current_time: {
    routingRole: 'time_authority',
    overlapGroup: 'time',
  ...
  web_search: {
    routingRole: 'general_web_search',
  ...
  skill_weather_cloud: {
    routingRole: 'weather_cloud_specialist',
    overlapGroup: 'weather',
  ...
  search_academic_paper: {
    routingRole: 'generic_academic_search',
  ...
  publish_qzone: {
    routingRole: 'qq_qzone_draft_alias',
    overlapGroup: 'qq_action',
  ...
  create_scheduled_command: {
    routingRole: 'qq_group_command_schedule',
    overlapGroup: 'qq_action',
  ...
  create_qzone_auto_task: {
    routingRole: 'qq_qzone_auto_schedule',
    overlapGroup: 'qq_action',
  ...
  cancel_scheduled_task: {
    routingRole: 'qq_schedule_cancel',
    overlapGroup: 'qq_action',
  ...
  delete_scheduled_task: {
    routingRole: 'qq_schedule_delete',
    overlapGroup: 'qq_action',
...
function getToolRoutingMetadata(toolName = '') {
  const metadata = TOOL_ROUTING_METADATA[String(toolName || '').trim()] || {};
  return {
    routingRole: String(metadata.routingRole || '').trim(),
...
function buildDirectChatToolCatalog(context = {}) {
  ...
  return toolNames.map((toolName) => {
    ...
    return {
      ...
      writeCapable,
      ...getToolRoutingMetadata(toolName)
    };
  });
}
...
function buildDirectChatToolCatalogSummary() {
  ...
  return catalog.map((descriptor) => ({
    ...
    routingRole: descriptor.routingRole,
