...
function buildRouterPrompt() {
  return [
    ...
    '    "reason": "string",',
    '    "admin": true,',
    '    "command": { "cmd": "full|help|status|reload|debug|meme|unknown", "args": ["string"], "raw": "string", "payload": "string" },',
    ...
    '3) 非管理员命中 /full 也必须输出 admin，并在 meta.command.cmd="full"、meta.admin=false；不要改成 refuse。',
