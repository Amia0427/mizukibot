...
function moodToneClass(mood) {
  if (mood === '愉快') return ' mood-happy';
  if (mood === '低落') return ' mood-low';
  return '';
}
...
function buildPrivateStatusBarHtml(input = {}, options = {}) {
  ...
  const moodClass = moodToneClass(data.mood);
  return [
    '<style>',
    ':root{font-family:"STKaiti","KaiTi","FangSong","Noto Serif CJK SC","Source Han Serif SC","Microsoft YaHei",serif;color:#5f463f;background:#fff}',
    '*{box-sizing:border-box}',
    '.status-bar{position:relative;width:960px;height:640px;overflow:hidden;background:#f3e7e0;border:1px solid #e7c9c0;color:#5f463f}',
    ...
    '.ribbon{position:absolute;width:250px;height:28px;background:rgba(232,166,168,.62);border:1px solid rgba(196,127,129,.45);transform:rotate(-17deg);opacity:.7}',
    ...
    '.photo-frame{position:absolute;z-index:2;left:43px;top:72px;width:330px;height:390px;padding:15px 15px 55px;background:#fffdfb;border:1px solid #d7c1b9;box-shadow:0 10px 12px rgba(122,86,78,.2);transform:rotate(-4deg)}',
    ...
    '.name-tag{position:absolute;left:30px;right:30px;bottom:12px;text-align:center;color:#6d4a41;font-size:26px;font-weight:700;line-height:1}',
    ...
    '.panel{position:absolute;z-index:1;left:395px;right:47px;padding:15px 22px 13px;overflow:hidden;background:#fffdfb;border:1px solid #d9b7ae;border-radius:8px;box-shadow:0 2px 6px rgba(134,95,86,.14)}',
    '.panel:before{content:"";position:absolute;left:0;top:0;bottom:0;width:4px;pointer-events:none}',
    '.affection-panel:before{background:#e79aa2}',
    '.mood-panel:before{background:#e2a08c}',
    '.thought-panel:before{background:#c2a2bd}',
    '.panel-title{position:relative;z-index:1;height:36px;margin:0;border-bottom:1px solid #d3a89f;color:#6d4a41;font-size:23px;font-weight:700;line-height:30px}',
    ...
    '.main-value strong{display:block;color:#c25f68;font-size:29px;line-height:1.2;overflow-wrap:anywhere}',
    ...
    '.meter{height:13px;margin-top:10px;border:1px solid #dca9a7;border-radius:9px;background:#f6e3e0;overflow:hidden}',
    '.meter>span{display:block;height:100%;border-radius:9px;background:#e08b93}',
    '.model-note{flex:1;min-width:0;margin:1px 0 0 18px;color:#5f463f;font-size:18px;line-height:1.4;overflow-wrap:anywhere}',
    '.model-note.text-medium{font-size:16px;line-height:1.34}',
    '.model-note.text-long{font-family:"Noto Sans CJK SC","Source Han Sans SC","Microsoft YaHei",sans-serif;font-size:13px;line-height:1.3}',
    ...
    '.mood-happy .heart-icon{color:#e2757f}.mood-happy .heart-icon:before{content:"♥"}',
    '.mood-low .heart-icon{color:#9d8fa8}',
    '.mood-main>div{min-width:0;flex:1}',
    '.mood-main strong{color:#c25f68;font-size:29px;line-height:1.2}',
    '.mood-main.mood-low strong{color:#8a7c96}',
    '.attitude{display:block;max-width:100%;margin-top:4px;color:#7d5a52;font-family:"Noto Sans CJK SC","Source Han Sans SC","Microsoft YaHei",sans-serif;font-size:12px;line-height:1.25;overflow-wrap:anywhere}',
    ...
    '.attitude.text-long{margin-top:6px;padding-right:16px;font-size:11px;line-height:1.25}',
    ...
    '.thought-text{min-width:0;margin:2px 0 0;color:#5f463f;font-size:18px;line-height:1.45;overflow-wrap:anywhere}',
    '.thought-text.text-medium{font-size:15.5px;line-height:1.38}',
    '.thought-text.text-long{font-family:"Noto Sans CJK SC","Source Han Sans SC","Microsoft YaHei",sans-serif;font-size:13.5px;line-height:1.34}',
    '.tip-panel{position:absolute;z-index:1;left:80px;bottom:38px;width:300px;height:112px;padding:17px 23px;overflow:hidden;background:#fffdfb;border:1px solid #d9b7ae;border-radius:8px}',
    '.tip-title{position:relative;z-index:1;height:29px;border-bottom:1px solid #d3a89f;color:#6d4a41;font-size:20px;font-weight:700;line-height:24px}',
    '.tip-title .bow{transform:scale(.58);transform-origin:left center;margin-right:-6px}',
    '.tip-list{position:relative;z-index:1;margin-top:4px;color:#6f5249;font-family:"Noto Sans CJK SC","Source Han Sans SC","Microsoft YaHei",sans-serif;font-size:12px;line-height:1.2}',
    ...
    '.tape-one{right:65px;top:45px}.tape-two{right:46px;top:452px;transform:rotate(14deg)}',
    '</style>',
    ...
    `<div class="panel-content"><div class="main-value mood-main${moodClass}${attitudeClass}"><span class="heart-icon" aria-hidden="true"></span><div><strong>`,
