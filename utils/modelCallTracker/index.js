...
function startModelCall(meta = {}) {
  ...
  const record = {
    ...
    main_model_pool_enabled: routeDiagnostics.mainModelPoolEnabled,
    main_model_pool_slot: routeDiagnostics.mainModelPoolSlot,
    main_model_pool_attempt: routeDiagnostics.mainModelPoolAttempt,
    main_model_pool_size: routeDiagnostics.mainModelPoolSize,
...
function finalizeRecord(id, patch = {}) {
  ...
  appendModelCallLog({
    ...
    main_model_pool_enabled: cloned.main_model_pool_enabled,
    main_model_pool_slot: cloned.main_model_pool_slot,
    main_model_pool_attempt: cloned.main_model_pool_attempt,
    main_model_pool_size: cloned.main_model_pool_size,
