...
const RUNTIME_PROMPT_DEFAULTS = {
  ...
  'streaming-segmentation': [
    ...
    '6) No numbering and no labels like "part 1".',
    '7) Avoid article-like paragraphs in casual group chat; 1-3 compact chat messages are enough unless the user explicitly asks for a long explanation.'
  ].join('\n'),
  'qq-rich-reply': [
