...
const RUNTIME_PROMPT_DEFAULTS = {
  ...
  'roleplay-inner-protocol': [
    ...
    'This is a silent pre-reply check for the main roleplay reply. Do not mention this block, do not reveal internal drafts, and only output the final user-facing text.',
    ...
    'Internal reasoning may use first-person phrases like “我心想”“我觉得”“我暗自” to plan emotion, relationship distance, plot direction, and the next reply. Keep that internal reasoning role-immersive, focused on story/reply planning, and never expose it in the final reply.',
    '',
