...
- 2026-06-03 07:52 +08:00：普通用户主回复流式首个可见字超时配置为 `NORMAL_USER_MAIN_REPLY_STREAM_FIRST_TOKEN_TIMEOUT_MS=75000`；仅限制普通用户主回复流式请求，超时 abort 上游并回复“流式输出75秒超时，已自动断开”，管理员不受影响。
