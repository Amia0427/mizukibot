...
- 2026-06-02 20:02 +08:00：普通用户主回复流式首个可见字超时配置改为 `NORMAL_USER_MAIN_REPLY_STREAM_FIRST_TOKEN_TIMEOUT_MS=75000`；仅限制普通用户主回复流式请求，超时 abort 上游并回复“上游繁忙，请稍后重试”，管理员不受影响。
