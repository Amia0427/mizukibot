...
- 2026-06-02 11:01 +08:00：本地 `.env` 已启用主动私聊：`TICK_ENGINE_ENABLED=true`、`PROACTIVE_PRIVATE_TOUCH_ENABLED=true`、`PROACTIVE_PRIVATE_TOUCH_USER_IDS=1960901788`；仍保持 `PROACTIVE_PRIVATE_TOUCH_REQUIRE_CONTEXT=true`、`PROACTIVE_PRIVATE_TOUCH_ALLOW_WILDCARD=false`、`PROACTIVE_PRIVATE_TOUCH_ALLOW_LIGHT_CARE=false`，避免无上下文主动私聊或通配群发。
