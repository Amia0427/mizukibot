...
## PJSK 曲库与谱面 RAG 2026-08-05 10:57 +08:00
...
- Docker 构建未通过：本机只有 Docker CLI，没有 daemon、Docker Desktop、WSL 或其他容器运行时，未擅自安装系统软件；源码、锁定 wheel 和字体配置已由静态测试覆盖，但不能宣称镜像构建成功。使用与维护见 [PJSK 曲库、谱面分析与 RAG](docs/pjsk-sql-rag.md)。
