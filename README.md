...
- 首阶段支持文本、图片、20 MiB 内文件和微信已提供转写文字的语音；不支持视频、原生语音回复及无转写语音的本地识别。实现与自动化验收见 [微信 iLink 私聊适配实施记录](docs/superpowers/plans/2026-08-06-weixin-ilink-private-adapter.md)。
