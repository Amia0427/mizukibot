...
更新 2026-06-02 20:02 +08:00：普通用户主回复流式请求首个可见字超时保护改为默认 `NORMAL_USER_MAIN_REPLY_STREAM_FIRST_TOKEN_TIMEOUT_MS=75000`；75 秒内无首字会 abort 上游并回复“上游繁忙，请稍后重试”，管理员不受该限制影响。
