...
## QQ 私聊状态栏 2026-08-17 10:02 +08:00
...
- 预警每小时扫描一次，同一人物同批预警合并为一条瑞希回复；23:00–07:30 的蓝色、黄色预警延迟到静默结束前重新确认，橙色、红色及未知等级立即发送；解除记录只更新状态，不调用模型或发送消息。V1 不提供群订阅、逐平台订阅、自定义静默时间、普通天气定时报送或解除通知。
