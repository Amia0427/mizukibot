...
module.exports = (() => {
  ...
  try {
    ...
    assert.strictEqual(privileged.isPrivilegedPrivateChatUser({ chatType: 'private', userId: 'tester_1', config }), false);
    ...
    assert.strictEqual(privileged.isPrivilegedPrivateChatUser({ chatType: 'private', userId: 'legacy_1', config }), false);
