...
module.exports = (async () => {
  ...
  const locations = {
    '朝阳': [
      { locationId: '101010300', name: '朝阳', adm1: '北京市', adm2: '北京', country: '中国', displayName: '北京市朝阳区' },
      { locationId: '101071201', name: '朝阳', adm1: '辽宁省', adm2: '朝阳', country: '中国', displayName: '辽宁省朝阳市' }
    ],
    '北京市朝阳区': [
      { locationId: '101010300', name: '朝阳', adm1: '北京市', adm2: '北京', country: '中国', displayName: '北京市朝阳区', latitude: '39.9219', longitude: '116.4436' }
    ]
  };
  ...
  assert.strictEqual((await service.subscribe('person-b', '東京都东京')).status, 'unsupported_region');
  assert.strictEqual(service.list('person-b').subscriptions.length, 0);
