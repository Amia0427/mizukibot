...
module.exports = {
  ...
  MESSAGE_INGRESS_ASYNC_MAX_QUEUE_LENGTH: Math.max(0, pickNum('MESSAGE_INGRESS_ASYNC_MAX_QUEUE_LENGTH', 200)),
  ...
  PRIVATE_INBOUND_GLOBAL_MAX_CONCURRENCY: Math.max(0, pickNum('PRIVATE_INBOUND_GLOBAL_MAX_CONCURRENCY', 3)),
  PRIVATE_INBOUND_GENERAL_MAX_CONCURRENCY: Math.max(0, pickNum('PRIVATE_INBOUND_GENERAL_MAX_CONCURRENCY', 3)),
  ...
  GEMINI_NATIVE_SYSTEM_PROMPT_ENABLED: pickBool('GEMINI_NATIVE_SYSTEM_PROMPT_ENABLED', true),
  GEMINI_SYSTEM_PROMPT_PATH: pick('GEMINI_SYSTEM_PROMPT_PATH', path.join(PROMPTS_DIR, 'GEMINI.txt')),
  GEMINI_ROLEPLAY_GUIDELINES_PATH: pick('GEMINI_ROLEPLAY_GUIDELINES_PATH', path.join(PROMPTS_DIR, 'persona', 'AI角色扮演规范文件.md')),
  GEMINI_ROLEPLAY_GUIDELINES_ENABLED: pickBool('GEMINI_ROLEPLAY_GUIDELINES_ENABLED', true),
  ...
  PRIVATE_INBOUND_QUEUE_TIMEOUT_MS: Math.max(0, pickNum('PRIVATE_INBOUND_QUEUE_TIMEOUT_MS', 180000)),
