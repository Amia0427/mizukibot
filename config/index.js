...
module.exports = {
  ...
  PROACTIVE_PRIVATE_TOUCH_ENABLED: pickBool('PROACTIVE_PRIVATE_TOUCH_ENABLED', false),
  PROACTIVE_PRIVATE_TOUCH_USER_IDS: pick('PROACTIVE_PRIVATE_TOUCH_USER_IDS', '')
    .split(',')
    .map((s) => s.trim())
    .filter(Boolean),
  PROACTIVE_PRIVATE_TOUCH_MIN_POINTS: pickNum(
    'PROACTIVE_PRIVATE_TOUCH_MIN_POINTS',
    pickNum('PROACTIVE_REPLY_MIN_POINTS', 150)
  ),
  PROACTIVE_PRIVATE_TOUCH_MAX_PER_DAY: pickNum('PROACTIVE_PRIVATE_TOUCH_MAX_PER_DAY', 2),
  PROACTIVE_PRIVATE_TOUCH_MIN_GAP_MINUTES: pickNum(
    'PROACTIVE_PRIVATE_TOUCH_MIN_GAP_MINUTES',
    pickNum('PROACTIVE_TOUCH_MIN_GAP_MINUTES', 240)
  ),
  PROACTIVE_PRIVATE_TOUCH_REQUIRE_CONTEXT: pickBool('PROACTIVE_PRIVATE_TOUCH_REQUIRE_CONTEXT', true),
  PROACTIVE_PRIVATE_TOUCH_ALLOW_WILDCARD: pickBool('PROACTIVE_PRIVATE_TOUCH_ALLOW_WILDCARD', false),
  PROACTIVE_PRIVATE_TOUCH_ALLOW_LIGHT_CARE: pickBool('PROACTIVE_PRIVATE_TOUCH_ALLOW_LIGHT_CARE', false),
  ...
  MEMORY_RERANK_CANDIDATE_LIMIT: pickLiteBudgetNum('MEMORY_RERANK_CANDIDATE_LIMIT', 32, 8),
