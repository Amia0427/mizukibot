...
module.exports = {
  ...
  NORMAL_USER_MAIN_REPLY_STREAM_FIRST_TOKEN_TIMEOUT_MS: Math.max(0, pickNum('NORMAL_USER_MAIN_REPLY_STREAM_FIRST_TOKEN_TIMEOUT_MS', 35000)),
  ...
  PASSIVE_AWARENESS_REPLY_USE_MAIN_MODEL: pickBool('PASSIVE_AWARENESS_REPLY_USE_MAIN_MODEL', true),
