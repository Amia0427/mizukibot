...
module.exports = {
  ...
  PRIVATE_PROACTIVE_IDLE_MINUTES: Math.max(1, pickNum('PRIVATE_PROACTIVE_IDLE_MINUTES', 180)),
  PRIVATE_PROACTIVE_MIN_GAP_MINUTES: Math.max(1, pickNum('PRIVATE_PROACTIVE_MIN_GAP_MINUTES', 360)),
